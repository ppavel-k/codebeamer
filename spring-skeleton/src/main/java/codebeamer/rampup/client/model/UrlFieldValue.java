 ...
 */
@JsonPropertyOrder({
  UrlFieldValue.JSON_PROPERTY_VALUE
})
...
public class UrlFieldValue extends AbstractFieldValue {
  ...
  **/
  ...
  @Override
  public UrlFieldValue fieldId(Integer fieldId) {
    this.setFieldId(fieldId);
    return this;
  }

  @Override
  public UrlFieldValue type(String type) {
    this.setType(type);
    return this;
  }

  @Override
  public UrlFieldValue name(String name) {
    this.setName(name);
    return this;
  }
